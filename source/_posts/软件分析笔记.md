...
may analysis：分析的结果可能是对的（over-approximation）
...
PFG和CG还是相互依赖着建立起来，只是现在带上了上下文敏感的信息

![image-20211118183730069](软件分析笔记/image-20211118183730069.png)

具体context sensitive的算法

## Context Sensitive Pointer Analysis

建立FPG边的规则

![image-20211118184353674](软件分析笔记/image-20211118184353674.png)

-

call的麻烦点

![image-20211118184724074](软件分析笔记/image-20211118184724074.png)
...
![image-20211118184818075](软件分析笔记/image-20211118184818075.png)

-

这个是CS的

![image-20211118185259193](软件分析笔记/image-20211118185259193.png)

注意，除了entry方法没有上下文，其他方法的上下文都是靠select函数取出来的
...
注意三个参数，调用者上下文，调用点，receiver object

![image-20211118191410768](软件分析笔记/image-20211118191410768.png)

-

> CI的select可以看作，无论传什么参数进来，都返回同一个上下文

### Call-Site Sensitivity

![image-20211118193221555](软件分析笔记/image-20211118193221555.png)

-

一个例子，没有递归的时候还是好的

![image-20211118193534609](软件分析笔记/image-20211118193534609.png)

-

有递归的时候，cs就无穷长了，得改改。

即使没有递归，对于一个正常的很长的调用链，全部考虑进来的话，也太长了。

![image-20211118193605152](软件分析笔记/image-20211118193605152.png)

-

引入一个k-limiting，我们只取最后k个call site

![image-20211118194422331](软件分析笔记/image-20211118194422331.png)

1-call-site，只看call site

2-call-site，看call site，和call site的call site

-

一个1-call-site的例子

![image-20211118195956633](软件分析笔记/image-20211118195956633.png)
...
![image-20211118200431356](软件分析笔记/image-20211118200431356.png)

-

一个例子

![image-20211118201451199](软件分析笔记/image-20211118201451199.png)

-

对比1-call-site和1-object

1-call-site在第一次set的时候还可以区分，在12行一起调用doSet的时候，丢失了第一次的call site，就区分不开了

![image-20211118201612756](软件分析笔记/image-20211118201612756.png)

-

用CG看更清楚，1-call-site就像进门，我只记得上一次从哪个门进来，上上次从哪进我就忘了

![image-20211118201727155](软件分析笔记/image-20211118201727155.png)

-

但在下面这种情况下，1-call-site更准确

一个方法调用两次，receiver是同一个，之后就区分不开了

![image-20211118201922187](软件分析笔记/image-20211118201922187.png)

-

所以这两种方法，不太好比较

但在OO语言里，object-sensitive表现得更好，因为它捕捉到了OO语言的特性，receiver越少越好。



### Type Sensitivity

比object-sensitive更加粗粒度，只看类型

![image-20211118202557307](软件分析笔记/image-20211118202557307.png)

-

对比object，不精确，但更快

![image-20211118202803171](软件分析笔记/image-20211118202803171.png)

-

### 三者对比

![image-20211118202833135](软件分析笔记/image-20211118202833135.png)

-

本讲重点

![image-20211118202938262](软件分析笔记/image-20211118202938262.png)